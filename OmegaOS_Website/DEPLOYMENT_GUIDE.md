...
**For Avalanche Fuji Testnet:** Use the RPC and chain ID from **AVAX_NETWORK_CONFIG.md**. Deploy the same contracts (Identity, Document Sync, Licensing) on Fuji and set the addresses in `identity-manager.js` or via env vars.

---

## Overview (Original: Omega Network)
