...
// Sync document to Avalanche Fuji
async function syncDocumentToOmega(content, fileName) {
    try {
        ...
        if (result && result.success) {
            console.log('Document synced to Avalanche Fuji:', result.txHash);
        }
    } catch (error) {
        console.error('Failed to sync document to Avalanche Fuji:', error);
