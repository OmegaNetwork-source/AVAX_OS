...
// Sync spreadsheet to Avalanche Fuji
async function syncSpreadsheetToOmega(spreadsheetData, fileName) {
    try {
        ...
        if (result && result.success) {
            console.log('Spreadsheet synced to Avalanche Fuji:', result.txHash);
        }
    } catch (error) {
        console.error('Failed to sync spreadsheet to Avalanche Fuji:', error);
