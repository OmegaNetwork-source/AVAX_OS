# Omega Network Configuration (Legacy)

**Note:** This codebase is now configured for **Avalanche Fuji Testnet (C-Chain)** by default. See **AVAX_NETWORK_CONFIG.md** and **BLOCKCHAIN_INTEGRATIONS.md** for current setup.

---

## Network Details (Omega – legacy)
