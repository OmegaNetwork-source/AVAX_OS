// Network configurations for AVAX Arcade (Fuji testnet) and optional Omega
const NETWORK_CONFIGS = {
    ...
    fuji: {
        chainId: '0xA86B', // 43113 Avalanche Fuji
        chainName: 'Avalanche Fuji C-Chain',
        nativeCurrency: { name: 'Avalanche', symbol: 'AVAX', decimals: 18 },
        rpcUrls: ['https://api.avax-test.network/ext/bc/C/rpc', 'https://rpc.ankr.com/avalanche_fuji', 'https://avalanche-fuji-c-chain-rpc.publicnode.com'],
        blockExplorerUrls: ['https://testnet.snowtrace.io'],
        contractAddress: '0x0000000000000000000000000000000000000000', // Deploy to Fuji, set in DEPLOY_LEADERBOARDS_FUJI.md
    }
};
...
export class WalletManager {
    constructor() {
        ...
        this.selectedNetwork = 'fuji'; // 'omega' | 'fuji'
    }

    setSelectedNetwork(networkKey) {
        if (networkKey === 'omega' || networkKey === 'fuji') {
    ...
    async submitScore(score) {
        ...
        const abi = this.selectedNetwork === 'fuji' ? unifiedAbi : omegaAbi;
        ...
        try {
            ...
            const tx = this.selectedNetwork === 'fuji'
