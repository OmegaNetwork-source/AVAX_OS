...
// Console easter egg
console.log('%c🎮 Welcome to AVAX Arcade!', 'font-size: 20px; color: #e63946; font-weight: bold;');
console.log('%cBuilt on Avalanche', 'font-size: 14px; color: #ff4466;');
console.log('%cPlay games. Compete. Win on AVAX.', 'font-size: 12px; color: #888;');
